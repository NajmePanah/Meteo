...
(function () {
  ...
  if (localStorage.getItem('templateCustomizer-' + templateName + '--Theme') === undefined || localStorage.getItem('templateCustomizer-' + templateName + '--Theme') === null)
    try {
      localStorage.setItem(`templateCustomizer-${templateName}--Theme`, "theme-semi-dark")
    } catch (e) {
    }
  ...
  function localize() {
    ...
    console.log(currentLanguageEle);
